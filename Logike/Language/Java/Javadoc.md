...
```java
/*
* @license Copyright (c) 2026. nValue.com.co . All rights reserved.
*/
```
# Clase
...
/**  
 * $(create a short description of the class)  
 * 
 * @author <a href="mailto:andres.rivera@nvalue.com.co">Andres Rivera</a>  
