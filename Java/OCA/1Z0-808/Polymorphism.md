...
Note that you can also declare an entire class final. A class that is declared final cannot be subclassed. This is particularly useful, for example, when creating an immutable class like the [`String`](https://docs.oracle.com/en/java/javase/24/docs/api/java.base/java/lang/String.html) class.