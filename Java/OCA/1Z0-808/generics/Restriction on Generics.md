...
If arrays of parameterized lists were allowed, the previous code would fail to throw the desired [`ArrayStoreException`](https://docs.oracle.com/en/java/javase/24/docs/api/java.base/java/lang/ArrayStoreException.html).

 

## Cannot Create, Catch, or Throw Objects of Parameterized Types

A generic class cannot extend the [`Throwable`](https://docs.oracle.com/en/java/javase/24/docs/api/java.base/java/lang/Throwable.html) class directly or indirectly. For example, the following classes will not compile:
