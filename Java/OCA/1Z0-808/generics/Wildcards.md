...
To write the method that works on lists of [`Number`](https://docs.oracle.com/en/java/javase/24/docs/api/java.base/java/lang/Number.html) and the subtypes of [`Number`](https://docs.oracle.com/en/java/javase/24/docs/api/java.base/java/lang/Number.html), such as [`Integer`](https://docs.oracle.com/en/java/javase/24/docs/api/java.base/java/lang/Integer.html), [`Double`](https://docs.oracle.com/en/java/javase/24/docs/api/java.base/java/lang/Double.html), and [`Float`](https://docs.oracle.com/en/java/javase/24/docs/api/java.base/java/lang/Float.html), you would specify `List<? extends Number>`. The term `List<Number>` is more restrictive than `List<? extends Number>` because the former matches a list of type [`Number`](https://docs.oracle.com/en/java/javase/24/docs/api/java.base/java/lang/Number.html) only, whereas the latter matches a list of type [`Number`](https://docs.oracle.com/en/java/javase/24/docs/api/java.base/java/lang/Number.html) or any of its subclasses.
...
The following code, using a list of [`Integer`](https://docs.oracle.com/en/java/javase/24/docs/api/java.base/java/lang/Integer.html) objects, prints `sum = 6.0`:
...
A list of [`Double`](https://docs.oracle.com/en/java/javase/24/docs/api/java.base/java/lang/Double.html) values can use the same `sumOfList()` method. The following code prints `sum = 7.0`:
...
- If you are writing a method that can be implemented using functionality provided in the [`Object`](https://docs.oracle.com/en/java/javase/24/docs/api/java.base/java/lang/Object.html) class.
- When the code is using methods in the generic class that do not depend on the type parameter. For example, [`List.size()`](https://docs.oracle.com/en/java/javase/24/docs/api/java.base/java/util/List.html#size\(\)) or [`List.clear()`](https://docs.oracle.com/en/java/javase/24/docs/api/java.base/java/util/List.html#clear\(\)). In fact, `Class<?>` is so often used because most of the methods in `Class<T>` do not depend on `T`.
...
The goal of `printList()` is to print a list of any type, but it fails to achieve that goal — it prints only a list of [`Object`](https://docs.oracle.com/en/java/javase/24/docs/api/java.base/java/lang/Object.html) instances; it cannot print `List<Integer>`, `List<String>`, `List<Double>`, and so on, because they are not subtypes of `List<Object>`. To write a generic `printList()` method, use `List<?>`:
...
It's important to note that `List<Object>` and `List<?>` are not the same. You can insert an [`Object`](https://docs.oracle.com/en/java/javase/24/docs/api/java.base/java/lang/Object.html), or any subtype of [`Object`](https://docs.oracle.com/en/java/javase/24/docs/api/java.base/java/lang/Object.html), into a `List<Object>`. But you can only insert `null` into a `List<?>`. The Guidelines for Wildcard Use paragraph at the end of this section has more information on how to determine what kind of wildcard, if any, should be used in a given situation.
...
Say you want to write a method that puts [`Integer`](https://docs.oracle.com/en/java/javase/24/docs/api/java.base/java/lang/Integer.html) objects into a list. To maximize flexibility, you would like the method to work on `List<Integer>`, `List<Number>`, and `List<Object>` — anything that can hold [`Integer`](https://docs.oracle.com/en/java/javase/24/docs/api/java.base/java/lang/Integer.html) values.

To write the method that works on lists of [`Integer`](https://docs.oracle.com/en/java/javase/24/docs/api/java.base/java/lang/Integer.html) and the supertypes of [`Integer`](https://docs.oracle.com/en/java/javase/24/docs/api/java.base/java/lang/Integer.html), such as [`Integer`](https://docs.oracle.com/en/java/javase/24/docs/api/java.base/java/lang/Integer.html), [`Number`](https://docs.oracle.com/en/java/javase/24/docs/api/java.base/java/lang/Number.html), and [`Object`](https://docs.oracle.com/en/java/javase/24/docs/api/java.base/java/lang/Object.html), you would specify `List<? super Integer>`. The term `List<Integer>` is more restrictive than `List<? super Integer>` because the former matches a list of type [`Integer`](https://docs.oracle.com/en/java/javase/24/docs/api/java.base/java/lang/Integer.html) only, whereas the latter matches a list of any type that is a supertype of [`Integer`](https://docs.oracle.com/en/java/javase/24/docs/api/java.base/java/lang/Integer.html).
...
Given that [`Integer`](https://docs.oracle.com/en/java/javase/24/docs/api/java.base/java/lang/Integer.html) is a subtype of [`Number`](https://docs.oracle.com/en/java/javase/24/docs/api/java.base/java/lang/Number.html), what is the relationship between `List<Integer>` and `List<Number>`?
...
Although [`Integer`](https://docs.oracle.com/en/java/javase/24/docs/api/java.base/java/lang/Integer.html) is a subtype of [`Number`](https://docs.oracle.com/en/java/javase/24/docs/api/java.base/java/lang/Number.html), `List<Integer>` is not a subtype of `List<Number>` and, in fact, these two types are not related. The common parent of `List<Number>` and `List<Integer>` is `List<?>`.

In order to create a relationship between these classes so that the code can access [`Number`](https://docs.oracle.com/en/java/javase/24/docs/api/java.base/java/lang/Number.html)'s methods through `List<Integer>`'s elements, use an upper bounded wildcard:
...
While `List<Integer>` and `List<Double>` both fulfill the criteria of `List<? extends Number>`, it is clearly incorrect to take an item from a list of [`Integer`](https://docs.oracle.com/en/java/javase/24/docs/api/java.base/java/lang/Integer.html) values and attempt to place it into a list of [`Double`](https://docs.oracle.com/en/java/javase/24/docs/api/java.base/java/lang/Double.html) values.
...
- In the case where the "in" variable can be accessed using methods defined in the [`Object`](https://docs.oracle.com/en/java/javase/24/docs/api/java.base/java/lang/Object.html) class, use an unbounded wildcard.
...
- You can add `null`.
- You can invoke [`clear()`](https://docs.oracle.com/en/java/javase/24/docs/api/java.base/java/util/List.html#clear\(\)).
- You can get the iterator and invoke [`remove()`](https://docs.oracle.com/en/java/javase/24/docs/api/java.base/java/util/List.html#remove\(java.lang.Object\)).
