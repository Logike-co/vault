...
To illustrate this last point, in the following example, inference determines that the second argument being passed to the pick method is of type [`Serializable`](https://docs.oracle.com/en/java/javase/24/docs/api/java.base/java/io/Serializable.html):
...
Alternatively, if you omit the type witness,a Java compiler automatically infers (from the method's arguments) that the type parameter is [`Integer`](https://docs.oracle.com/en/java/javase/24/docs/api/java.base/java/lang/Integer.html):
...
In this example, the compiler infers the type [`Integer`](https://docs.oracle.com/en/java/javase/24/docs/api/java.base/java/lang/Integer.html) for the formal type parameter, `X`, of the generic class `MyClass<X>`. It infers the type [`String`](https://docs.oracle.com/en/java/javase/24/docs/api/java.base/java/lang/String.html) for the formal type parameter, `T`, of the constructor of this generic class.
...
Consider the following two functional interfaces ([`java.lang.Runnable`](https://docs.oracle.com/en/java/javase/24/docs/api/java.base/java/lang/Runnable.html) and [`java.util.concurrent.Callable<V>`](https://docs.oracle.com/en/java/javase/24/docs/api/java.base/java/util/concurrent/Callable.html):
...
The method [`Runnable.run()`](https://docs.oracle.com/en/java/javase/24/docs/api/java.base/java/lang/Runnable.html#run\(\)) does not return a value, whereas [`Callable<V>.call()`](https://docs.oracle.com/en/java/javase/24/docs/api/java.base/java/util/concurrent/Callable.html#call\(\)) does.
